...
zip -r ./dist/todo-list-block.zip \
	block.json \
	src/todo-item/block.json \
        todo-list-block.php \
        license.txt \
	$build_files \
	readme.txt

# Reset `todo-list-block.php`.
git checkout todo-list-block.php

# Unzip plugin zip file
unzip ./dist/todo-list-block.zip -d "./dist/todo-list-block/"
